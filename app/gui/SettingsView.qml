...
FocusScope {
    ...
    readonly property var categories: [qsTr("Display and quality"), qsTr("Input Settings"), qsTr("Audio Settings"), qsTr("Connection and diagnostics"), qsTr("Appearance and general"), qsTr("Advanced Settings")]
    signal languageChanged
    onCategoryChanged: {
        settingsPage.contentY = 0;
    }
    ...
    StackView.onActivated: {
        ...
        if (SdlGamepadKeyNavigation.getConnectedGamepads() > 0) {
            if (categorySelector.visible)
                categorySelector.forceActiveFocus(Qt.TabFocusReason);
            else
    ...
    ColumnLayout {
        ...
        spacing: 16
        Label {
            text: qsTr("Choose your streaming preferences. Changes are saved when you leave settings.")
        ...
        ComboBox {
            ...
            visible: settingsRoot.width < 900
            Layout.fillWidth: true
            model: settingsRoot.categories
            currentIndex: settingsRoot.category
            onActivated: settingsRoot.category = currentIndex
        }
        RowLayout {
            Layout.fillWidth: true
            ...
            ColumnLayout {
                ...
                Repeater {
                    ...
                    delegate: ItemDelegate {
                        ...
                        highlighted: settingsRoot.category === index
                        onClicked: settingsRoot.category = index
                        background: Rectangle {
                            radius: 8
                            color: parent.highlighted ? window.selectionColor : parent.hovered ? window.surfaceColor : "transparent"
            ...
            Flickable {
                ...
                Window.onActiveFocusItemChanged: {
                    ...
                    if (item) {
                        ...
                        if (pos.y - scrollMargin < contentY) {
                            ...
                            autoScrollAnimation.from = contentY;
                            autoScrollAnimation.to = Math.max(0, Math.min(pos.y + item.height + scrollMargin - height, contentHeight - height));
                            autoScrollAnimation.start();
                        }
                    }
                }
                ...
                Column {
                    id: settingsContent
                    width: Math.max(0, settingsPage.width - 12)
                    spacing: 20
                    GroupBox {
                        id: basicSettingsGroupBox
                        visible: settingsRoot.category === 0
                        ...
                        Column {
                                ...
                                AutoResizingComboBox {
                                    ...
                                    function updateBitrateForSelection() {
                                        ...
                                        if (StreamingPreferences.width !== selectedWidth || StreamingPreferences.height !== selectedHeight) {
                                            ...
                                            if (StreamingPreferences.autoAdjustBitrate) {
                                                StreamingPreferences.bitrateKbps = StreamingPreferences.getDefaultBitrate(StreamingPreferences.width, StreamingPreferences.height, StreamingPreferences.fps, StreamingPreferences.enableYUV444);
                                    ...
                                    NavigableDialog {
                                        ...
                                        function isInputValid() {
                                            ...
                                            // reject the input.
                                            if ((!widthField.acceptableInput && widthField.text) || (!heightField.acceptableInput && heightField.text)) {
                                                return false;
                                            }

                                            // The textboxes need to have text or placeholder text
                                            if ((!widthField.text && !widthField.placeholderText) || (!heightField.text && !heightField.placeholderText)) {
                                                return false;
                                            }
                            ...
                            CheckBox {
                                ...
                                ToolTip.timeout: 5000
                                ToolTip.visible: hovered
                                ToolTip.text: enabled ? qsTr("The stream will be HDR-capable, but some games may require an HDR monitor on your host PC to enable HDR mode.") : qsTr("HDR streaming is not supported on this PC.")
                            }
                            CheckBox {
                                id: enableYUV444
                                contentItem: Label {
                                ...
                                ToolTip.timeout: 5000
                                ToolTip.visible: hovered
                                ToolTip.text: enabled ? qsTr("Good for streaming desktop and text-heavy games, but not recommended for fast-paced games.") : qsTr("YUV 4:4:4 is not supported on this PC.")
                            }
                        }
                    }
                    ...
                    GroupBox {
                        ...
                        visible: settingsRoot.category === 1
                        width: (parent.width - (parent.leftPadding + parent.rightPadding))
                        padding: 12
                        ...
                        Column {
                            ...
                            CheckBox {
                                ...
                                ToolTip.visible: hovered
                                ToolTip.text: qsTr("This enables seamless mouse control without capturing the client's mouse cursor. It is ideal for remote desktop usage but will not work in most games.") + " " + qsTr("You can toggle this while streaming using Ctrl+Alt+Shift+M.") + "\n\n" + qsTr("NOTE: Due to a bug in GeForce Experience, this option may not work properly if your host PC has multiple monitors.")
                            }
                    ...
                    GroupBox {
                        ...
                        Column {
                            ...
                            CheckBox {
                                ...
                                ToolTip.timeout: 5000
                                ToolTip.visible: hovered
                                ToolTip.text: qsTr("Forces a single gamepad to always stay connected to the host, even if no gamepads are actually connected to this PC.") + " " + qsTr("Only enable this option when streaming a game that doesn't support gamepads being connected after startup.")
                            }
                    ...
                    GroupBox {
                        ...
                        visible: settingsRoot.category === 2
                        width: (parent.width - (parent.leftPadding + parent.rightPadding))
                        padding: 12
                    ...
                    GroupBox {
                        id: connectionSettingsGroupBox
                        visible: settingsRoot.category === 3
                        width: parent.width
                        padding: 16
                        title: qsTr("Connection and diagnostics")
                        Column {
                            width: parent.width
                            spacing: 12
                            CheckBox {
                    ...
                    GroupBox {
                        ...
                        visible: settingsRoot.category === 4
                        width: (parent.width - (parent.leftPadding + parent.rightPadding))
                        padding: 12
                        ...
                        Column {
                            ...
                            Flow {
                                spacing: 12
                                Button {
                                    text: qsTr("Light appearance")
                                    checked: !window.darkTheme
                                    onClicked: window.darkTheme = false
                                }
                                Button {
                                    text: qsTr("Dark appearance")
                                    checked: window.darkTheme
                                    onClicked: window.darkTheme = true
                                }
                            }
                            Label {
                                id: languageTitle
                    ...
                    GroupBox {
                        ...
                        visible: settingsRoot.category === 5
                        width: (parent.width - (parent.leftPadding + parent.rightPadding))
                        padding: 12
