Moonlight Desk Preview - Windows x64

Run MoonlightDeskPreview-Setup-x64.exe to install for the current user.
...
The preview only hosts while Moonlight is running and you are signed in.
...
The test installer is unsigned and may trigger Windows SmartScreen.
