...
$TestPython = if ($env:DESK_TEST_PYTHON) { $env:DESK_TEST_PYTHON } else { 'python' }
& $TestPython (Join-Path $PSScriptRoot 'test-desk-access.py') (Join-Path $InstallDir 'host/sunshine/sunshine.exe')
